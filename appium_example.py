...
USERNAME = os.environ.get('SAUCE_USERNAME', "isaacm")
ACCESS_KEY = os.environ.get('SAUCE_ACCESS_KEY', "de6d6ab5-0bb3-4e27-b7e9-3c716597a73f")
sauce = SauceClient(USERNAME, ACCESS_KEY)

browsers = [{"appium-version": "1.2.3",
             "platformVersion": "7.1",
             "platformName": "iOS",
